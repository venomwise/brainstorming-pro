...
test("parses start, resume, status, and decisions", () => {
  assert.deepEqual(parseBrainstormProArgs("\"Build a thing\" --topic my-topic"), { action: "start", request: "Build a thing", topic: "my-topic" });
